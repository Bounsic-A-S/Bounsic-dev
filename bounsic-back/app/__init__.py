...
from app.routes import algoritms_router, bert_router, crawl_router, scrapping_router,song_router, db_router,health_router
...
app.include_router(algoritms_router, prefix="/algorithms", tags=["Algorithms"])
